...
int2 = [start2 end2];
int3 = [start3 end3];
power_time = i_c2.time;
%power_time2 = power_time + 5.0693 - 0.7188 - 0.0678 + 0.0056;
time = i_c2.time;
time2 = time + 4.2883;
...
plot(ax1, power_time2, double(p_c2_ref.data)./s_N, 'Color', [0 0.6 0], 'LineStyle','--', 'LineWidth', 1.2)
plot(ax1, power_time2, double(q_c2_ref.data)./s_N, 'Color', [0 0.8 0.8], 'LineStyle','--', 'LineWidth', 1.2)
hold(ax1, "off")
xticks(ax1, ticks1)
ax1.Box = 'off';
xlim(ax1,int1)
...
plot(ax2, power_time2, double(p_c2_ref.data)./s_N, 'Color', [0 0.6 0], 'LineStyle','--', 'LineWidth', 1.2)
plot(ax2, power_time2, double(q_c2_ref.data)./s_N, 'Color', [0 0.8 0.8], 'LineStyle','--', 'LineWidth', 1.2)
hold(ax2, "off");
xticks(ax2, ticks2);
...
plot(ax3, power_time2, double(p_c2_ref.data)./s_N, 'Color', [0 0.6 0], 'LineStyle','--', 'LineWidth', 1.2)
plot(ax3, power_time2, double(q_c2_ref.data)./s_N, 'Color', [0 0.8 0.8], 'LineStyle','--', 'LineWidth', 1.2)
hold(ax3, "off");
xticks(ax3, ticks3);
